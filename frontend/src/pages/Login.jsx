              ...
              <form className="mt-10 space-y-6" onSubmit={handleLogin}>
                <div className="space-y-5">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2 ml-1">
                      ...
                      <button
                        type="button"
                        className="text-xs font-bold text-primary hover:text-secondary hover:underline underline-offset-4 decoration-2 decoration-primary/20 transition-all"
                      >
                        Forgot password?
                      </button>
                    </div>
                ...
                <div className="flex items-center ml-1">
                  <input
                    ...
                    className="h-5 w-5 rounded-lg border-gray-200 text-primary focus:ring-primary transition-all cursor-pointer"
                  />
                  <label htmlFor="remember-me" className="ml-3 block text-sm font-medium text-text-muted cursor-pointer hover:text-text-primary transition-colors">
                    Remember me
                  </label>
                </div>
                ...
                <div className="text-center mt-8">
                  <p className="text-text-muted font-medium text-sm">
                    ...
                    <Link to="/register" className="font-bold text-accent hover:text-secondary underline underline-offset-4 decoration-2 decoration-accent/20 hover:decoration-accent transition-all">
                      Create Account
                    </Link>
                  </p>
                </div>
